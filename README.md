...
| Subsequence string search | |[javascript](../main/Go/subsequenceStringSearch.js)|[typescript](../main/JavaScript/subsequenceStringSearch.ts)| | [go](../main/TypeScript/subsequence_string_search.go)|